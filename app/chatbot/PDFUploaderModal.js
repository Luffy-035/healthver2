                        ...
                        <div className="space-y-2">
                            ...
                            <ScrollArea className="h-32 border border-zinc-700 rounded-lg p-2">
                                {selectedFiles.map((file, index) => (
                                    <div key={index} className="flex items-center justify-between p-2 hover:bg-zinc-800 rounded">
                    ...
                    {uploading && (
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                <span className="text-sm text-zinc-400">Processing files...</span>
                                <span className="text-sm text-zinc-400">{uploadProgress}%</span>
                            </div>
                            <Progress value={uploadProgress} className="w-full bg-zinc-800" indicatorColor="bg-emerald-600" />
                        </div>
                    )}
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div className="bg-zinc-700 p-4 rounded-lg border border-emerald-600/30">
                                        <div className="text-2xl font-bold text-emerald-400">{results.parsed_json?.length || 0}</div>
                                        <div className="text-sm text-zinc-400">Reports Analyzed</div>
                                    </div>
                                    <div className="bg-zinc-700 p-4 rounded-lg border border-emerald-600/30">
                                        <div className="text-2xl font-bold text-emerald-400">{results.total_files}</div>
                                        <div className="text-sm text-zinc-400">Files Processed</div>
                                    </div>
                                    <div className="bg-zinc-700 p-4 rounded-lg border border-emerald-600/30">
                                        <div className="text-2xl font-bold text-emerald-400">{results.pdf_download_urls?.length || 0}</div>
                                        <div className="text-sm text-zinc-400">Downloads Available</div>
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="space-y-2">
                                            {results.pdf_download_urls.map((item, index) => (
                                                <div key={index} className="flex items-center justify-between p-3 border border-zinc-700 rounded-lg">
                                                    <div className="flex items-center space-x-2">
                                                        <FileText className="h-4 w-4 text-emerald-400" />
